...
public:
        ...
        HWND GetHwnd() const { return (HWND)(lParam); }
        WORD GetNotifyCode() const { return HIWORD(wParam); }
#endif
};
...
public:
        int GetWidth() const { return LOWORD(lParam); }
        int GetHeight() const { return HIWORD(lParam); }
};
