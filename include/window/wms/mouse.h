...
public:
        ...
        Bool IsCtrlDown() const { return Bool(UINT81FROMMP(GetMP2())&kss_ctrl); }
        Bool IsShiftDown() const { return Bool(UINT81FROMMP(GetMP2())&kss_shift); }

        int GetX() const { return (int)(sint16)UINT161FROMMP(GetMP1()); }
        int GetY() const { return (int)(sint16)UINT162FROMMP(GetMP1()); }
...
public:
        WmsHWND GetHwndCursor() const { return HWNDFROMMP(GetMP2()); }     //WMS
